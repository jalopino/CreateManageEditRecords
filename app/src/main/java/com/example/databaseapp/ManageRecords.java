        ...
        private class Gender extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    cPostSQL = cItemcode;
                    cv.put("code", cPostSQL);
                    JSONObject json = jsonParser.makeHTTPRequest(urlHostGender, "POST", cv);
                    if (json != null) {
                        nSuccess = json.getInt(TAG_SUCCESS);
                        if (nSuccess == 1) {
                            online_dataset = json.getString(TAG_MESSAGE);
        ...
        private class Civil extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    cPostSQL = cItemcode;
                    cv.put("code", cPostSQL);
                    JSONObject json = jsonParser.makeHTTPRequest(urlHostCivilStatus, "POST", cv);
                    if(json != null) {
                        nSuccess = json.getInt(TAG_SUCCESS);
                        if (nSuccess == 1) {
                            online_dataset = json.getString(TAG_MESSAGE);
            ...
            private class id extends AsyncTask<String, String, String> {
                ...
                protected void onPostExecute(String aydi) {
                    ...
                    if (aydi != null) {
                        ...
                        Toast.makeText(ManageRecords.this, "Data selected", Toast.LENGTH_SHORT);
                            String AYDI = aydi;
                            String str = AYDI;
                    ...
                    protected void onPostExecute(String del) {
                        ...
                        if (aydi != null) {
                            if (isEmpty.equals("") && !del.equals("HTTPSERVER_ERROR")) { }
                                Toast.makeText(ManageRecords.this, "Data Deleted", Toast.LENGTH_SHORT);
                            } else {
                                alert.setMessage("Query Interrupted... \nPlease Check Internet Connection");
                                alert.setTitle("Error");
                                alert.show();
